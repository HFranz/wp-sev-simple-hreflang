...
const SEV_HREFLANG_UNINSTALL_META_KEY = 'hreflang_alternates';

/**
 * Löscht das hreflang-Post- und Term-Meta auf der aktuellen Site.
 */
function sev_hreflang_uninstall_current_site(): void {
	global $wpdb;
	...
	$wpdb->delete( $wpdb->postmeta, array( 'meta_key' => SEV_HREFLANG_UNINSTALL_META_KEY ) );
	$wpdb->delete( $wpdb->termmeta, array( 'meta_key' => SEV_HREFLANG_UNINSTALL_META_KEY ) );
	// phpcs:enable
}
...
if ( is_multisite() ) {
	...
	foreach ( $site_ids as $site_id ) {
		...
		sev_hreflang_uninstall_current_site();
